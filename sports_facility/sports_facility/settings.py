"""
Django settings for sports_facility project.
...
ALLOWED_HOSTS = ['*']  # Consider restricting this to your Render domain in production
...
CORS_ALLOW_CREDENTIALS = True  # If your frontend sends cookies or auth headers